...
public class MemoService {
    ...
    public String createRandomNickName() {
        String[] nickname1 =
                {"행복한", "배고픈", "평화로운", "야호! ", "꿈꾸는", "화가 난", "달려라", "꿈꾸는", "노는게 제일 좋은", "하늘을 나는", "여행 가고 싶은", "영 앤 리치", "바쁘다 바빠!", "하고 싶은 말이 많은", "어른스러운", "깜찍한", "엉뚱한", "소심한", "화이팅!", "두둠칫", "용감한", "판타스틱", "메롱~ ", "슬기로운", "게으른", "여유로운", "소중한", "살 찐", "만지면 무는", "기분 좋은", "그게 나야", "힙합 전사", "Y2K", "흥부자", "나야나", "에너자이저", "끼쟁이"};
        String[] nickname2 =
                {"말레이시아곰", "티벳여우", "블롭피쉬", "골든햄스터", "썬더람쥐", "알각고래", "패럿", "뉴기니아앵무", "노루", "판다", "알파카", "기린", "바다표범", "가자미", "가오리", "물개", "카피바라", "거북이", "쿼카", "해달", "코브라", "치타", "표범", "나무늘보", "아르마딜로", "기니피그", "해파리", "긴날개여치", "왈라비", "사슴벌레", "개코도마뱀", "까마귀", "뻐꾸기", "슈가 글라이더", "개미햝기"};
